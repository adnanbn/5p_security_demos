...
| Branch | Draft PR | Expected red gate | Lecture connection |
| --- | --- | --- | --- |
| [`demo/01-authz-cross-user`](https://github.com/adnanbn/5p_security_demos/tree/demo/01-authz-cross-user) | [PR #1](https://github.com/adnanbn/5p_security_demos/pull/1) | Laravel tests | Authentication versus authorization; generic scanners stay green |
| [`demo/02-secret-in-history`](https://github.com/adnanbn/5p_security_demos/tree/demo/02-secret-in-history) | [PR #2](https://github.com/adnanbn/5p_security_demos/pull/2) | Secret scanning | A committed credential must be revoked, not merely deleted |
