...
| [`INPUT-01`](INPUT-01/README.md) | Valid input is not automatically writable input | Validated allowlist of user-editable fields | `demo/06-over-posting` |
| [`WEBHOOK-01`](WEBHOOK-01/README.md) | A valid signature does not prevent replay | Signature, freshness, and idempotency checks | `demo/07-webhook-replay` |
| [`SSRF-01`](SSRF-01/README.md) | Outbound requests cross a network boundary | Configured destinations and outbound policy | `demo/08-ssrf-outbound` |
| [`XSS-01`](XSS-01/README.md) | Framework escaping can be bypassed deliberately | Render untrusted content as text | `demo/09-unsafe-html` |
